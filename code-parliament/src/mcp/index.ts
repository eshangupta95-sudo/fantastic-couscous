...
export async function startMCPServer(daemon: ParliamentDaemon): Promise<void> {
    ...
    try {
      ...
      switch (name) {
        ...
        case 'parliament_verdict':
          result = await handlers.parliament_verdict(args as any);
          break;
        case 'parliament_debate':
          result = await handlers.parliament_debate(args as any);
          break;
        case 'parliament_ignore':
          result = await handlers.parliament_ignore(args as any);
          break;
        case 'parliament_config':
          result = await handlers.parliament_config(args as any);
          break;
